...
const blogPosts = [
  {
    ...
    excerpt:
      "Discover why multidimensional, organic color is still reigning supreme and how bonding tech changed everything.",
  ...
  },
  {
    ...
    excerpt:
      "Winter demands more than just deep conditioning. Learn to care for the literal root of the issue.",
  ...
  },
  {
    ...
    excerpt:
      "Structural geometry is taking over modern grooming. Heres how to talk to your barber.",
  ...
  },
  {
    ...
    excerpt:
      "Cutting through the marketing speak to understand what ingredients your hair actually needs.",
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <p className="mt-8 text-xl leading-relaxed text-zinc-400 max-w-2xl">
            An editorial exploration into the modern world of hair, grooming,
            product science, and aesthetic expression.
          </p>
        </motion.div>
        ...
        <BentoGrid columns={3} className="mb-12">
          <BentoBox
            colSpan={2}
            className="group min-h-[500px] flex flex-col justify-end p-0 overflow-hidden relative cursor-pointer"
          >
            <div
            ...
            <div className="relative z-20 p-10 md:p-14 w-full">
              <div className="flex gap-3 mb-6">
                <Badge className="bg-violet-500 text-white border-none">
                  {featuredPost.category}
                </Badge>
                <Badge
                  variant="outline"
                  className="border-white/20 bg-black/40 backdrop-blur-md text-white gap-2 text-xs py-1"
                >
          ...
          <BentoBox
            colSpan={1}
            className="bg-gradient-to-br from-[#0d0d12] to-violet-900/10 flex flex-col justify-between"
          >
            <div>
              ...
              <div className="space-y-4">
                {["Trends", "Care", "Styling", "Products", "Culture"].map(
                  (cat) => (
                    <button
                      key={cat}
                      className="w-full flex items-center justify-between text-left p-4 rounded-xl border border-white/5 bg-white/5 hover:border-violet-500/30 hover:bg-violet-500/10 transition-all group"
                    >
                      <span className="font-semibold text-zinc-300 group-hover:text-violet-300">
                        {cat}
                      </span>
            ...
            <div className="mt-8 pt-8 border-t border-white/5">
              <p className="text-sm text-zinc-500 mb-4">
                Subscribe to our dispatch for early access to styling events and
                product drops.
              </p>
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-black/40 border border-white/10 rounded-lg px-4 text-sm outline-none focus:border-violet-500"
                />
                <button className="bg-white text-black font-bold px-4 py-2 rounded-lg text-sm hover:bg-zinc-200">
                  Join
                </button>
              </div>
            </div>
          ...
          {standardPosts.map((post) => (
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="mb-4">
                  <span className="text-xs font-bold uppercase tracking-wider text-violet-400 bg-violet-400/10 px-3 py-1.5 rounded-full">
                    {post.category}
                  </span>
                </div>
